...
if (isset($_SESSION['logged_in'])) {
    if (isset($_GET['id'])) {
        ...
        if (empty($title) or empty($content)) {
            ...
            $query = $pdo->prepare("UPDATE about SET about_title = ?, about_content = ? WHERE about_id = ?");
            ...
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container-fluid center">
                        ...
                        <br>
                        <form action="edit_about.php?id=1" method="post" autocomplete="off">
                            <input type="text" name="title" placeholder="Title" value="<?php echo $data['about_title']; ?>"><br><br>
